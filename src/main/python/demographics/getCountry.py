...
with open('data/cities.csv') as citiesFiles:
...
if __name__ == '__main__':
    ...
    classifications = []
    with open('data/countryClassifications.txt') as classificationsFile:
    ...
    with open('data/countryTestfileNOPUSH.csv') as testfile:
    ...
    with open('data/addressListNOPUSH.csv') as addresses:
